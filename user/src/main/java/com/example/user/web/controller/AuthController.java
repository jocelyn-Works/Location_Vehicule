...
import com.example.user.dao.RoleRepository;
...
import com.example.user.payload.response.UserInfoResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        User user = new User(
                ...
                signUpRequest.getPermitCode(),
                signUpRequest.getDateOfObtaining(),
